...
router.post('/:id/refresh-market-value-from-url', refreshMarketValueFromUrl);
router.post('/:id/reset-market-value', resetMarketValue);
router.post('/:id/price-sources', savePriceSources);
